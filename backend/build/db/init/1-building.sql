...
CREATE DATABASE data_sets;
 ...
 /* CREATE TABLE */
CREATE TABLE IF NOT EXISTS data_sets.buildings(   
...
/* INSERT QUERY */
INSERT INTO data_sets.buildings( building_name,latitude,longitude )
VALUES
(
...
VALUES
(
    '(愛知工業大学)地域防災研究センター',35.18481385,137.1105387
);
